 ...
 * @author Haifeng Li
 */
public class GLassoMultivariateGaussianDistribution extends AbstractMultivariateDistribution implements MultivariateExponentialFamily {
     ...
     * @param var variance.
     */
    public GLassoMultivariateGaussianDistribution(double[] mean, double var) {
        if (var <= 0) {
     ...
     */
    public GLassoMultivariateGaussianDistribution(double[] mean, double[][] cov) {
    ...
    public GLassoMultivariateGaussianDistribution(double[] mean, double[][] precision, boolean inverse) {
     ...
     */
    public GLassoMultivariateGaussianDistribution(double[][] data) {
        this(data, false);
    }
     ...
     */
    public GLassoMultivariateGaussianDistribution(double[][] data, boolean diagonal) {
    ...
    public MultivariateMixture.Component M(double[][] x, double[] posteriori) {
        ...
        c.priori = alpha;
        GLassoMultivariateGaussianDistribution g = new GLassoMultivariateGaussianDistribution(mean, cov);
        g.diagonal = diagonal;
        c.distribution = g;
