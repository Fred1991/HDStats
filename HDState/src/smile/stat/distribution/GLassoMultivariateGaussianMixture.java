 ...
 * @author Haifeng Li
 */
public class GLassoMultivariateGaussianMixture extends MultivariateExponentialFamilyMixture {

    /**
     * Constructor.
     * @param mixture a list of multivariate Gaussian distributions.
     */
    public GLassoMultivariateGaussianMixture(List<Component> mixture) {
        super(mixture);
    }
     ...
     */
    public GLassoMultivariateGaussianMixture(double[][] data, int k) {
        this(data, k, false);
    }
     ...
     */
    public GLassoMultivariateGaussianMixture(double[][] data, int k, boolean diagonal) {
        if (k < 2)
     ...
     * @param data the training data.
     */
    public GLassoMultivariateGaussianMixture(double[][] data) {
        this(data, false);
    }
    ...
    public GLassoMultivariateGaussianMixture(double[][] data, boolean diagonal) {
        if (data.length < 20)
