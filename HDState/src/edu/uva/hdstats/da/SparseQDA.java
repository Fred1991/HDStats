 ...
 * @author Haifeng Li
 */
public class SparseQDA implements Classifier<double[]> {
    ...
    public static class Trainer extends ClassifierTrainer <double[]>{
        ...
        public SparseQDA train(double[][] x, int[] y) {
            return new SparseQDA(x, y, priori, tol);
        }
    }
     ...
     */
    public SparseQDA(double[][] x, int[] y) {
        this(x, y, null);
    }
     ...
     */
    public SparseQDA(double[][] x, int[] y, double[] priori) {
     ...
     * will reject variables whose variance is less than tol<sup>2</sup>.
     */
    public SparseQDA(double[][] x, int[] y, double tol) {
        this(x, y, null, tol);
    }
     ...
     * will reject variables whose variance is less than tol<sup>2</sup>.
     */
    public SparseQDA(double[][] x, int[] y, double[] priori, double tol) {
