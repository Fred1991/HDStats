...
public class L2NZMF {
	...
	public L2NZMF(Matrix _R, double[][] _nonzeros, double _lp, double _lq) {
		this.R = _R;
		this.lambdaP = _lp;
		this.lambdaQ = _lq;
	...
	public static class PRiskFunction implements RiskFunction {
		...
		public PRiskFunction(L2NZMF _mf) {
			this.mf = _mf;
		}
	...
	public static class QRiskFunction implements RiskFunction {
		...
		public QRiskFunction(L2NZMF _mf) {
			this.mf = _mf;
		}
	...
	public static ChainedFunction getRiskFunction(Matrix R, double[][] nonz, double _lp, double _lq) {
		L2NZMF mf = new L2NZMF(R, nonz, _lp, _lq);
	...
	public static void main(String[] args) throws IOException {
		...
		int i = 30;
		ChainedFunction cf = getRiskFunction(toM,null, 0, 0);
