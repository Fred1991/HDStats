...
public class DGLassoGMMGraph extends SampleCovarianceEstimator{
	...
	public DGLassoGMMGraph(double[][] data, int size) {
		this.size = size;
	...
	public int[][] thresholdingDiff(double t, double e, DGLassoGMMGraph wg) {
		List<int[][]> tGraphs = new ArrayList<int[][]>();
		for (int i = 0; i < this.size; i++)
			tGraphs.add(sampledGraphs.get(i).thresholding(t));
	...
	public int[][] adaptiveThresholdingDiff(double t, double overlap, DGLassoGMMGraph wg) {
		List<int[][]> tGraphs = new ArrayList<int[][]>();
		for (int i = 0; i < this.size; i++)
			tGraphs.add(sampledGraphs.get(i).adaptiveThresholding(t));
		List<int[][]> wGraphs = new ArrayList<int[][]>();
