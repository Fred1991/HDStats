...
public class RegularizedBayesLDA extends SDA {
	...
	public RegularizedBayesLDA(double[][] d, int[] g, int size, int K) {
		super(d, g, false);
	...
	public static void main(String[] args) {
		...
		RegularizedBayesLDA test = new RegularizedBayesLDA(data, group, 1000, 1);
