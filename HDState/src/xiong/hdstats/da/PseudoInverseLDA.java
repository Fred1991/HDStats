...
public class PseudoInverseLDA implements Classifier<double[]>{
	...
	public PseudoInverseLDA(double[][] d, int[] g, boolean p) {
	...
	public static void main(String[] args) {
		...
		PseudoInverseLDA test = new PseudoInverseLDA(data, group, true);
