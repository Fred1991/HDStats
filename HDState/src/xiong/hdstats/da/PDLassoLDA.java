 ...
 * @author Haifeng Li
 */
public class PDLassoLDA implements Classifier<double[]> {
    ...
    public static class Trainer  extends ClassifierTrainer <double[]>{
        ...
        public PDLassoLDA train(double[][] x, int[] y) {
            return new PDLassoLDA(x, y, priori, tol);
        }
    }
     ...
     */
    public PDLassoLDA(double[][] x, int[] y) {
        this(x, y, null);
    }
     ...
     */
    public PDLassoLDA(double[][] x, int[] y, double[] priori) {
     ...
     * will reject variables whose variance is less than tol<sup>2</sup>.
     */
    public PDLassoLDA(double[][] x, int[] y, double tol) {
        this(x, y, null, tol);
    }
     ...
     * will reject variables whose variance is less than tol<sup>2</sup>.
     */
    public PDLassoLDA(double[][] x, int[] y, double[] priori, double tol) {
